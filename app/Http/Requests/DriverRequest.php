...
class DriverRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return 
        [
            'driver_license_number' => 'required|string|unique:drivers,driver_license_number|regex:/^[0-9]{8}$/',
            ...
            'car_license_number' => 'required|string|unique:drivers,car_license_number|regex:/^[0-9]{10}$/',
